...
import CC_04_MutexSem.CC_04_MutexSem.Contador;
import CC_04_MutexSem.CC_04_MutexSem.Decrementador;
import CC_04_MutexSem.CC_04_MutexSem.Incrementador;
...
class CC_04_MutexSem {
   ...
   private static int N_PASOS = 10000;
   
   static volatile Semaphore exMutua = new Semaphore(1);
